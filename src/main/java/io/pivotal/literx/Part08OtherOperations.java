...
//========================================================================================
	...
	Flux<User> userFluxFromStringFlux(Flux<String> usernameFlux, Flux<String> firstnameFlux, Flux<String> lastnameFlux) {
		Flux<User> fluxResponse = Flux.zip(usernameFlux, firstnameFlux, lastnameFlux)
				.map(userAttributes -> new User(userAttributes.getT1(), userAttributes.getT2(), userAttributes.getT3()));
